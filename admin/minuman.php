<?php
/**
 * Drinks dashboard — default minuman station, or the staff member's assigned station.
 */
...
$station = resolveKitchenStation($user, (int) $shop['id'], $requested > 0 ? $requested : null, 'minuman');
